...
#     ABSTRACT_FROM => q[lib/Eixo/RestServer.pm]
#     AUTHOR => [q[Francisco <fmaseda@>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Eixo::RestServer]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Eixo/RestServer.pm]
...
MAKE = make
FULLEXT = Eixo/RestServer
BASEEXT = RestServer
PARENT_NAME = Eixo
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Eixo/RestServer.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
DISTNAME = Eixo-RestServer
DISTVNAME = Eixo-RestServer-0
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Eixo-RestServer",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Francisco &lt;fmaseda@&gt;</AUTHOR>' >> $(DISTNAME).ppd
